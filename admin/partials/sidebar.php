...
<div id="postbox-container-1" class="postbox-container">
    <div class="meta-box-sortables">
        ...
        <div class="postbox">
            <h3><?php _e( 'Help & Supports', 'cbxwpreadymix' ); ?></h3>
            <div class="inside">
        ...
        <div class="postbox">
            <h3><?php _e( 'Codeboxr Updates', 'cbxwpreadymix' ); ?></h3>
            <div class="inside">
				<?php
        ...
        <div class="postbox">
            <h3><?php _e( 'Other Wordpress Plugins', 'cbxwpreadymix' ); ?></h3>
            <div class="inside">
				<?php
					include_once( ABSPATH . WPINC . '/feed.php' );
					if ( function_exists( 'fetch_feed' ) ) {
        ...
        <div class="postbox">
            <h3><?php _e( 'Codeboxr on facebook', 'cbxwpreadymix' ) ?></h3>
            <div class="inside">
                <iframe src="//www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2Fcodeboxr&amp;width=260&amp;height=258&amp;show_faces=true&amp;colorscheme=light&amp;stream=false&amp;border_color&amp;header=false&amp;appId=558248797526834"
