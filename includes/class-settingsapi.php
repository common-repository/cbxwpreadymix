...
// If this file is called directly, abort.
	 ...
	 *
	 */
	if ( ! class_exists( 'CBXWPReadyMixSettings' ) ):

		class CBXWPReadyMixSettings {
			...
			function callback_multiselect( $args ) {
				...
				if ( isset( $args['optgroup'] ) && $args['optgroup'] ) {
					foreach ( $args['options'] as $opt_grouplabel => $dataOpt ) {
						...
						$data      = isset( $dataOpt['data'] ) ? $dataOpt['data'] : array();
                ...
                <script type="text/javascript">
                    jQuery(document).ready(function ($) {
                        ...
                        if (typeof(localStorage) != 'undefined') {
                            activetab = localStorage.getItem("cbxwpreadymix");
                        }
                        ...
                        $('.nav-tab-wrapper a').click(function (evt) {
                            ...
                            if (typeof(localStorage) != 'undefined') {
                                localStorage.setItem("cbxwpreadymix", $(this).attr('href'));
                            }
                            $('.group').hide();
