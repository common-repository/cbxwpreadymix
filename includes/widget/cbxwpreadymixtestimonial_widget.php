<?php
	...
	/**
	 * Add CBXWPReadymixTestimonial_Widget widget.
	 */
	class CBXWPReadymixTestimonial_Widget extends WP_Widget {

		protected $widget_slug = 'cbxtestimonial';
		...
		function __construct() {
			...
			parent::__construct( 'cbxwpreadymixtestimonial_widget', // Base ID
				esc_html__( 'CBX Testimonial', 'cbxwpreadymix' ), // Name
				array(
                     'classname'  => 'widget-'.$this->get_widget_slug(),
                     'description' => esc_html__( 'Show Testimonial', 'cbxwpreadymix' ),
				) // Args
			);
		...
		public function widget( $args, $instance ) {
			...
			echo CBXWPReadymixContentMapperView::cbxwpreadymix_testimonial_content_view( $instance );
...
// register storeinformation_widget
	function cbxwpreadymixtestimonial_widget() {
		register_widget( 'CBXwpReadymixTestimonial_Widget' );
	}

	add_action( 'widgets_init', 'cbxwpreadymixtestimonial_widget' );